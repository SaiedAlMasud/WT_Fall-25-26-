...
<body>
    ...
    <div class="main-container">
        ...
        <div class="cencel-apnt-success-error-msg">
            <?php if (isset($success)): ?><h3><?php echo $success ?></h3><?php endif; ?>
            <?php if (isset($error)): ?><h3><?php echo $error ?></h3><?php endif; ?>
        </div>
    ...
    <script>
        function loadApntDetails(appointmentId) {
            ...
            apntDetails.open('GET', 'GetAppointmentDetails.php?appointment_id=' + appointmentId, true);
